...
namespace BlinovaCpp {
	...
	/// Сводка для Form6_1
	/// </summary>
	public ref class Form6_1 : public System::Windows::Forms::Form
	{
	public:
		Form6_1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(157, 248);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(222, 55);
			this->button1->TabIndex = 5;
			this->button1->Text = L"ОК";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Form6_1::button1_Click);
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(157, 178);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(157, 83);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		bool f = MyDll1::Class2::Vopros1(textBox2);
		if (f == true) {
			Form6_2^ f62 = gcnew Form6_2();
			f62->Show();
			this->Close();
		}
	}
