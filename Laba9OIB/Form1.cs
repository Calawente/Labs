...
namespace Laba4
{
    public partial class Form1 : Form
    {
        ...
        private void подписатьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            switch (comboBox1.SelectedIndex)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    signature = RSA.SignData(databytes, new SHA256Managed());
                    break;
                case 3:
                    signature = RSA.SignData(databytes, new SHA384Managed());
                    break;
                case 4:
                    signature = RSA.SignData(databytes, new SHA512Managed());
                    break;
                default:
                    signature = RSA.SignData(databytes, new MD5CryptoServiceProvider());
                    break;
        ...
        private void openFileDialog4_FileOk(object sender, CancelEventArgs e)
        {
            ...
            fs.Close(); switch (comboBox1.SelectedIndex)
            {
                case 0:
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (RSA.VerifyData(databytes, new SHA256Managed(), signature))
                    {
                        label1.Text = "Подпись верна";
                    }
                    else
                    ...
                    break;
                case 3:
                    if (RSA.VerifyData(databytes, new SHA384Managed(), signature))
                    {
                        label1.Text = "Подпись верна";
                    }
                    else
                    ...
                    break;
                case 4:
                    if (RSA.VerifyData(databytes, new SHA512Managed(), signature))
                    {
                        label1.Text = "Подпись верна";
                    }
                    else
